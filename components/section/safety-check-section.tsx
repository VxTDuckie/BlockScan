...
const SafetyCheck = () => {
    const fakeResults = [
        ...
        { check: 'Ownership is renounced', status: '/images/shield-x.png',bg: 'bg-black' },
        ...
        { check: 'Audit report found', status: '/images/shield-x.png', bg: 'bg-black' },
        { check: 'Audit report found', status: '/images/shield-x.png', bg: 'bg-black' },
        { check: 'Audit report found', status: '/images/error.png', bg: 'bg-black' },
        { check: 'Audit report found', status: '/images/error.png', bg: 'bg-black' },
      ];
    return (
      <main>
