...
export default function Footer() {
  return (
    <footer className="bg-white text-gray-800 w-full px-12">
        ...
        <div className="flex justify-between items-start gap-12">
          <div className='flex flex-col gap-6'>
            ...
            <div className="flex justify-start space-x-4">
              ...
              {/* Facebook Link */}
              <button className='border-[2px] border-gray-300 rounded-full p-2  hover:text-primary-red hover:border-primary-red/50wwd hover:scale-105 transition-all duration-300'>
          ...
          <div className='flex flex-col gap-4 font-semibold'>
            <div>
              <a href='https://www.google.com/maps/place/Swinburne+Vietnam+-+HCMC+Campus/@10.8162023,106.6664322,17z/data=!3m1!4b1!4m6!3m5!1s0x31752ff6c51d5ebd:0x4403e126c229b92b!8m2!3d10.8162023!4d106.6690071!16s%2Fg%2F11fszkyqgr?entry=ttu&g_ep=EgoyMDI0MTEwNS4wIKXMDSoASAFQAw%3D%3D' 
              target='_blank'
            ...
            <div className='flex gap-2'>
              <a href='mailto:nguyenphuoc4805@gmail.com'
               target='_blank'
               className='flex gap-2 hover:text-primary-red hover:scale-105 duration-300 transition-all'>
